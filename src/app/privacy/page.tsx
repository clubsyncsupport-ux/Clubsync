          ...
          <main>
            ...
            <div className="legal-part">
              ...
              <section className="legal-clause" id="p8">
                ...
                <p>We keep your account and activity data for as long as your account is active. You can delete your account and personal information yourself at any time from Settings, and it&rsquo;s removed right away — that currently includes everything tied to your account, including your service-hour history.</p>
                <p>We know that&rsquo;s not quite right for verified service hours specifically — a school may need to retain those totals as part of its own records even after you delete your account, and today&rsquo;s all-or-nothing deletion doesn&rsquo;t yet support keeping the school&rsquo;s copy of that record separate from your personal account. Building that separation properly, with a retention period the school itself confirms rather than one we invent, is a planned improvement, not something already in place — this policy describes what deletion actually does today, not what&rsquo;s planned.</p>
